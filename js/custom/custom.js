...
function percent() {
    ...
    e = (t <= 99 || (t = 99), !percentFlag && 100 + e >= document.documentElement.clientHeight && document.querySelector("#waterfall") ? (console.info(e, document.documentElement.clientHeight), setTimeout(function() {
        waterfall("#waterfall")
    },
    ...
    a = document.getElementById("post-comment") || document.getElementById("footer");
    a.offsetTop + a.offsetHeight / 2 < e || 90 < t ? (document.querySelector("#nav-totop").classList.add("long"), n.innerHTML = "返回顶部", percentFlag = !0) : (document.querySelector("#nav-totop").classList.remove("long"), n.innerHTML = t)
}
function ScrollBarElongation() {
    document.documentElement.scrollTop || window.pageYOffset,
    Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight),
    document.documentElement.clientHeight,
    document.querySelector(".as-indicator")
}
// 存数据
